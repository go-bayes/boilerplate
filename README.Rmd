...
- **JSON Default Format**: Human-readable JSON as default. RDS writing is deprecated; existing RDS databases remain readable and can be migrated with `boilerplate_migrate_to_json()`
...
The `boilerplate` package is under active development. Here's our planned roadmap for upcoming features:

### 🚀 Near Term
**Enhanced Documentation and Examples (v1.3.1)**
- Comprehensive example testing framework
- Enhanced vignette coverage for all workflows
- Improved error messages with helpful suggestions
- Video tutorials for common workflows

### 📋 Medium Term  
**Enhanced Type Safety (v1.4.x)**
