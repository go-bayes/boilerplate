...
**New in v1.1.0**: The package now uses a single unified JSON database by default, simplifying database management and improving version control compatibility.
