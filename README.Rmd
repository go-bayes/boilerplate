...
All key functions in the package (`boilerplate_init()`, `boilerplate_import()`, and `boilerplate_save()`) accept a `data_path` parameter to specify a custom location. When working with custom paths, be sure to use the same path consistently across all functions.
...
Bulbulia, J. (2025). boilerplate: Tools for Managing and Generating Standardised Text for Scientific Reports. R package version 1.0.1 https://doi.org/10.5281/zenodo.13370825
