...
#'
#' @return List. Default measures database.
#'
#' @noRd
get_default_measures_db <- function() {
  # this would be implemented to return default measures
  ...
  list(
    anxiety_gad7 = list(
      ...
      description = "anxiety was measured using the GAD-7 scale, a 7-item instrument that measures severity of generalised anxiety disorder.",
      reference = "spitzer2006",
      waves = "1-3",
      keywords = c("anxiety", "mental health", "gad"),
      items = list(
