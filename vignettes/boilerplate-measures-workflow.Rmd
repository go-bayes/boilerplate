...
Measures in `boilerplate` describe variables, instruments, and scales used in research. This vignette shows how to store measure metadata, standardise measure entries, and generate formatted methods text from those entries.
...
1. Verify that the measure structure matches the examples
...
This workflow keeps measure descriptions consistent across research documentation while preserving the item-level details needed for methods sections and appendices.
