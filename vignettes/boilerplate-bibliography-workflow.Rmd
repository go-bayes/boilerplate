...
# Note: The cache directory is system-specific
# On Unix-like systems (Mac/Linux): ~/.boilerplate/cache
# On Windows: Usually in %APPDATA%/boilerplate/cache
cache_dir <- file.path(Sys.getenv("HOME"), ".boilerplate", "cache")

# Alternative: Use platform-independent approach
# if (!requireNamespace("rappdirs", quietly = TRUE)) {
#   install.packages("rappdirs")
# }
# cache_dir <- file.path(rappdirs::user_cache_dir("boilerplate"), "cache")
