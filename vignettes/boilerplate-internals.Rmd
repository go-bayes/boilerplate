...
The internal functions in `boilerplate` define how the package navigates databases, writes files, and generates text. This vignette documents those non-exported functions for contributors who need to understand the package architecture.
...
```r
# Internal function in json-support.R
write_boilerplate_db(db, file, format = "json")
```
