...
1. **Use Version Control**: Export your databases regularly for version control
   ...
   boilerplate_export(
    ...
    quiet = TRUE
     ...
     db = unified_db,
     output_file = "boilerplate_backup_2024.json"
   )
   ```
...
boilerplate_save(
  db = unified_db,
  timestamp = TRUE  # Creates boilerplate_unified_20240115_143022.json
)

# Import a specific timestamped version
old_version <- boilerplate_import(
  data_path = "boilerplate/data/boilerplate_unified_20240110_120000.json"
)
```
