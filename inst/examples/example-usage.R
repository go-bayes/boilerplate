...
# Simply print the database or use names() to see entries
names(measures_db)
...
temp_methods_db <- boilerplate_remove_entry(
  db = methods_db,
  path = "sample.nzavs"
)
...
temp_methods_db <- boilerplate_add_entry(
  db = methods_db,
  path = "sample.nzavs",
  value = list(
...
methods_db <- boilerplate_add_entry(
  db = methods_db,
...
# boilerplate_save(db = methods_db, category = "methods")
...
# methods_db <- boilerplate_import(category = "methods")
